...
const pageContent = [
  ...
  },
  {
    ...
    content: "Programmes & Interventions Prioritised Programmes Mass financial inclusion services, focused on the financial systems layer, and internationalisation of mass inclusion. A.I. enabled growth (development) bank through the roll-up of NBFCs to build a global financial institution through targeted acquisitions and partnerships beginning in India to roll out of mass financial inclusion platforms and solutions. Digital technologies focused on the cognitive systems layer, unlocking human potential through experiences, education, enlightenment. Delivering mass education, experiences and enlightenment to liberate minds and raise human consciousness, the enlightenment of the 21st century combining eastern and western definitions. Prioritised Shared Programs The Cognitive Sovereignty Initiative: Securing the capacity of nations, institutions, and individuals to govern, compete, and choose freely in the face of cognitive capture in the rising tech-enabled Age of Systems. Industrial-Societal Transition, AI Trust Labs: Designing the institutional, industrial, and social architectures that allow nations to transition constructively into the information era without fracture or subordination. National Prosperity and Growth: Building the systems of enterprise, growth, and wealth creation that deliver the prosperity without which no nation can sustain stability, sovereignty, or freedom. Large Scale Thematic Capital Allocation: Mobilising and directing capital toward the transitions, technologies, and sovereignties that will determine the distribution of power and wealth in the next era. Mass Financial Inclusion: The spread of mass financial inclusion in the conversion of low to middle income populations through technology, financial, and policy change.",
  },
  {
